...
extra_labels | List of {name: "", content: ""} to be run in this pod on startup | []
...
on_load.startup | List of {name: "", content: ""} to be run in this pod on startup | []
on_load.init | List of {name: "", content: ""} to be run in this pod on initialisation | []
